...
## Возможный план отчета
Если будешь делать заранее, обычно там такой план: тема, введение в предметную область, актуальность, исследование аналогов, выявление минусов(отличий), постановка задачи (Мб какие-то требования), что сделано, что планируется в следующем семестре
